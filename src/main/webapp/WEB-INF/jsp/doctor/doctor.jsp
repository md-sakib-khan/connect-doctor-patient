...
<head>
    <title>
        <fmt:message key="title.doctor"/>
    </title>
</head>
<body>
<c:set var="action" value="${doctor.isNew() ? 'SAVE' : 'UPDATE'}"/>

<div class="container">
    <div class="card user-form-section">
        <div class="row">
            <div class="h1 text-center mb-5">
                <fmt:message key="text.doctor"/>
            </div>
        </div>
        ...
        <form:form method="post" modelAttribute="doctor">
            ...
            <div class="row w-75 m-auto d-flex justify-content-center">
                <form:label cssClass="custom-form-label" path="degree">
                    <fmt:message key="label.degree"/>
                    <strong class="text-danger">*</strong>
                </form:label>
                <form:input path="degree"
                            ...
                            cssClass="form-control form-control-lg bg-transparent border-dark"/>
                <div class="error-section">
                    <form:errors path="degree" cssClass="error-message"/>
                </div>
            </div>

            <div class="row w-75 m-auto d-flex justify-content-center">
                <form:label cssClass="custom-form-label" path="yearsOfExperience">
                    <fmt:message key="label.experience.years"/>
                    <strong class="text-danger">*</strong>
                </form:label>
                <form:input path="yearsOfExperience"
                            cssClass="form-control form-control-lg bg-transparent border-dark"/>
                <div class="error-section">
                    <form:errors path="yearsOfExperience" cssClass="error-message"/>
                </div>
            </div>
